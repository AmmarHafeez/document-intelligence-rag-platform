...
The initial version includes unit-tested local retrieval components for ingestion, chunking, keyword retrieval, TF-IDF vector retrieval, saved index loading, extractive grounded answer generation, retrieval evaluation, evaluation metrics, and FastAPI serving.
